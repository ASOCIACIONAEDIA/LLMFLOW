...
def register_all_tasks():
    ...
    from app.workers.tasks.discoveries.product_discovery_task import ProductDiscoveryTask
    task_registry.register_task("discovery_product", ProductDiscoveryTask)
