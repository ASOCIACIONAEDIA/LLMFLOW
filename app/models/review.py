...
class Review(Base):
    ...
    discovered_product_id: Mapped[int | None] = mapped_column(ForeignKey("discovered_products.id", ondelete="SET NULL"))
    discovered_place_id: Mapped[int | None] = mapped_column(ForeignKey("discovered_places.id", ondelete="SET NULL"))
